...
<div id="container" style="position:center; top:25px; right:25px; width:100%; height: 85%; margin-left: 2px;margin-right: 2px;padding-right: 0px;padding-left: 0px">
    <img id="sm1" srcset='/1.jpeg 30w, /1.jpeg 30w' sizes='(min-width: 10px) 10px, 30vw' class="smile" src="/1.jpeg" style="display: none">
    <img id="sm2" srcset='/2.jpeg 30w, /2.jpeg 30w' sizes='(min-width: 20px) 20px, 30vw' class="smile" src="/2.jpeg" style="display: none">
    <img id="sm3" srcset='/3.jpg 30w, /3.jpeg 30w' sizes='(min-width: 20px) 20px, 30vw' class="smile" src="/3.jpg" style="display: none">
    <img id="sm4" srcset='/4.jpg 30w, /4.jpeg 30w' sizes='(min-width: 20px) 20px, 30vw' class="smile" src="/4.jpg" style="display: none">
    <img id="sm5" srcset='/5.jpeg 30w, /5.jpeg 30w' sizes='(min-width: 20px) 20px, 30vw' class="smile" src="/5.jpeg" style="display: none">
    <img id="sm6" srcset='/6.jpeg 30w, /6.jpeg 30w' sizes='(min-width: 20px) 20px, 30vw' class="smile" src="/6.jpeg" style="display: none">
